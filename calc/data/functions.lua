...
return {
    ...
    ['arcsin'] = function(x) return math.asin(x) * math.pi / 180 end,
    ['arccos'] = function(x) return math.acos(x) * math.pi / 180 end,
    ['arctan'] = function(x) return math.atan(x) * math.pi / 180 end,
